...
fn test_select_jury_is_random() {
    new_test_ext().execute_with(|| {
        ...
        let jury_1 = <crate::Pallet<Test> as SelectJury<AccountId>>::select_jury(1);
        let jury_2 = <crate::Pallet<Test> as SelectJury<AccountId>>::select_jury(1);

        assert!(jury_1[0] != jury_2[0]);

        let jury_1 = <crate::Pallet<Test> as SelectJury<AccountId>>::select_jury(100);
        let jury_2 = <crate::Pallet<Test> as SelectJury<AccountId>>::select_jury(100);
...
fn test_select_jury_stress_test() {
    new_test_ext().execute_with(|| {
        ...
        for _ in 0..u8::MAX {
            <crate::Pallet<Test> as SelectJury<AccountId>>::select_jury(255);
        }
    });
}
