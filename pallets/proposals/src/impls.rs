...
impl<T: Config> Pallet<T> {
    ...
    pub fn new_contribution(
        ...
        ensure!(value > Zero::zero(), Error::<T>::InvalidParam);
    ...
    pub fn add_refunds_to_queue_depricated(project_key: ProjectKey) -> DispatchResultWithPostInfo {
        ...
        let mut locked_milestone_percentage: Percent = Percent::zero();
        ...
        for (who, contribution) in project.contributions.iter() {
            ...
            let refund_amount = locked_milestone_percentage.mul_floor(contribution.value);
