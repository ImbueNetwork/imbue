...
pub fn gen_hash(seed: u8) -> Lazy<H256> {
	Lazy::new(||{H256::from([seed; 32])})
}
static DEPOSIT_OK: <Test as Config>::MinimumDeposit::get() + 1000;
static BOUNTY_OK = <Test as Config>::MinimumBounty::get() + 1000;

let d_above_minimum =  + amount;
